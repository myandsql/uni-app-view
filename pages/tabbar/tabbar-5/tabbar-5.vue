...
<view class="container">
  ...
  <view v-else class="info-container">
    <image class="login-avatar" :src="userInfo.avatar ? userInfo.avatar : userInfo.gender === 1? '/static/img/boy.png' : '/static/img/girls.png'"></image>
    <view class="bussiness-info">
      <view class="name">{{userInfo.nickName}}</view>
    </view>
    <view class="edit-info">
    <text class="desc" @click="editInformation">编辑资料</text>
        <image class="arrow" src="/static/img/ic_arrow.png"></image>
    </view>
  </view>
...
<style lang="scss" scoped>
	 ...
	 .collect-img, .history-img{
	   width: 48rpx;
	   height: 48rpx;
	   margin-right: 20rpx;
	 }
	 
	 .order-serve, .other-serve {
	   position: relative;
	   width: 710rpx;
	   height: 252rpx;
	   background: #FFFFFF;
