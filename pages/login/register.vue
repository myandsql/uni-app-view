<template>
	<view class="register">
		...
		<view class="content">
			...
			<!-- 主体 -->
			<view class="main">
				<wInput v-model="emailData" type="text" placeholder="邮箱" @blur="checkEmail"></wInput>
				<wInput v-model="password" type="password" placeholder="密码" isShowPass></wInput>
				<view class="main_box">
					<wInput ref="runCode" v-model="captcha" type="number" placeholder="验证码" isShowCode
						@setCode="getcaptcha" class="main_box_code"></wInput>
				</view>
			</view>
